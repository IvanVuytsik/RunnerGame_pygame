...
class Player (pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        player_walk1 = pygame.image.load('venv/knight0.png').convert_alpha()
        player_walk1 = pygame.transform.scale(player_walk1, (150, 150))
        player_walk2 = pygame.image.load('venv/knightwalk2.png').convert_alpha()
        player_walk2 = pygame.transform.scale(player_walk2, (150, 150))
        self.player_walk = [player_walk1,player_walk2]

        self.player_index = 0

        self.player_jump = pygame.image.load('venv/knightwalk2.png').convert_alpha()
        self.player_jump = pygame.transform.scale(self.player_jump, (150, 150))

        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom=(150,380))

        self.jump = pygame.mixer.Sound('venv/jump.mp3')
...
class Obstacle (pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'Witch':
            ...
            self.animation = [witch_stand, witch_move]
            y_pos = 210
        else:
            type == 'Knight'
            ...
            self.animation = [knight_stand, knight_move]
            y_pos = 385
    ...
    def animation_state(self):
        ...
        if self.animation_index >= len(self.animation): self.animation_index = 0
...
def collision_sprites ():
    if pygame.sprite.spritecollide(player.sprite,obstacle_group,False):
        ...
        return False#bool is used for True/False chec
    else: return True
...
#---------------------------Music---------------------------
bg_music1 = pygame.mixer.Sound('venv/Song1.mp3')
bg_music1.set_volume(0.3)
bg_music2 = pygame.mixer.Sound('venv/Song2.mp3')
bg_music2.set_volume(0.3)
bg_music3 = pygame.mixer.Sound('venv/Song3.mp3')
bg_music3.set_volume(0.3)

play_music = [bg_music1, bg_music2, bg_music3]
music = random.choice(play_music)
if music == bg_music1: bg_music1.play(loops = -1)
elif music == bg_music2: bg_music2.play(loops = -1)
else: bg_music3.play(loops = -1)
...
#Group or GroupSingle - multiple or single sprite
#-------------------------------------------------------------------
...
#------------------------Updates obstacle_rect_list and passes randomly a knight or a witch------
        if game_active:
            if event.type == obstacle_timer:
                obstacle_group.add(Obstacle(choice(['Witch','Knight','Knight','Knight'])))
                #if randint(0,2):
